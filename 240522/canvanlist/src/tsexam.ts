...
// const introduce = (name = "dmswls") => {
//   console.log(`name:${name}`);
// };

// // 2) 함수에 선택적 매개변수'
// // ? : 값이 들어 올수도 안올수도
// const introduce01 = (name = "mingu", tall?: number) => {
//   console.log(`name:${name}`);
...
// // 4) 함수 타입표현식 => 함수 타입별칭
// //  - interface extens || type 대수타입 유니온 / 인터섹션타입
...
// // 반론 제기 => 어떤 값이 들어올지 미정, 타입 cheat key : any
