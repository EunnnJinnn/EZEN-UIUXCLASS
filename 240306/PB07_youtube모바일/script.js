// 마우스 스크롤 , 손가락 스크롤을 하던 스크롤 이벤트 필요함
...
// 컴퓨터 혹은 모바일 디바이스는 사용자가 얼만큼 스크롤을 했는지 어떻게 알 수 있나

// scrollWidth : 사용자가 스크롤을 할 수 있는 컨텐츠의 전체 총 너비값

// clientWidth : 사용자의 눈으로 확인이 가능한 디바이스 매체상의 너비값

// scrollWidth - clientWidth = 스크롤이 가능한 영역의 너비
...
// getComputedStyle = 트랜스폼, 위치 이동값에 대한 정보를 갖고있는 함수
